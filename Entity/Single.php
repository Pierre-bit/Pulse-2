...
class Single
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Artiste", inversedBy="singles")
     */
    private $artistes;
    ...
    /**
     * @var File|null
     * @vich\UploadableField(mapping="single_image", fileNameProperty="filename")
     */
    private $imageSingle;
     ...
     * @return  self
     */ 
    public function setImageSingle($imageSingle)
    {
        $this->imageSingle = $imageSingle;
        if ($this->imageSingle instanceof UploadedFile) {
